  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final displayName = user?.displayName ??
          (email.isNotEmpty ? email.split('@').first : 'Seller');
      final nameCapitalized = displayName.isNotEmpty
          ? displayName[0].toUpperCase() + displayName.substring(1)
          : displayName;
      final restaurantName = userService.restaurantName ?? '';
          ...
          SliverToBoxAdapter(
            child: Stack(
              ...
              children: [
                    ...
                    children: [
                      ...
                      if (restaurantName.isNotEmpty) ...[
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                colorScheme.onSecondary.withValues(alpha: 0.18),
                ...
                // Decorative bubbles — identical to client profile
                Positioned(
                    top: 20,
                    right: 16,
